...
class DefaultController extends Controller
{
    ...
    {
        return $this->render('BinovoTknikaBackupsBundle:Default:about.html.twig');
    }
    ...
    public function deleteClientAction(Request $request, $id)
    {
        $t = $this->get('translator');
        $db = $this->getDoctrine();
        $repository = $db->getRepository('BinovoTknikaBackupsBundle:Client');
        $manager = $db->getManager();
    ...
    public function editClientAction(Request $request, $id)
    {
        if ('new' === $id) {
            ...
            $repository = $this->getDoctrine()
                ->getRepository('BinovoTknikaBackupsBundle:Client');
            $client = $repository->find($id);
        }
        ...
        return $this->render('BinovoTknikaBackupsBundle:Default:client.html.twig',
    ...
    public function deleteJobAction(Request $request, $idClient, $idJob)
    {
        $t = $this->get('translator');
        $db = $this->getDoctrine();
        $repository = $db->getRepository('BinovoTknikaBackupsBundle:Job');
        $manager = $db->getManager();
    ...
    public function editJobAction(Request $request, $idClient, $idJob)
    {
        if ('new' === $idJob) {
            ...
            $client = $this->getDoctrine()
                ->getRepository('BinovoTknikaBackupsBundle:Client')->find($idClient);
            if (null == $client) {
            ...
            $job = $this->getDoctrine()
                ->getRepository('BinovoTknikaBackupsBundle:Job')->find($idJob);
        }
    ...
    public function showJobBackupAction(Request $request, $idClient, $idJob, $action, $path)
    {
        ...
        if (is_dir($realPath)) {
            if ('download' == $action) {
                ...
                return $this->render('BinovoTknikaBackupsBundle:Default:directory.html.twig',
    ...
    public function editPolicyAction(Request $request, $id)
    {
        ...
        if ('new' === $id) {
            ...
            $policy = $this->getDoctrine()
                ->getRepository('BinovoTknikaBackupsBundle:Policy')->find($id);
        }
    ...
    public function savePolicyAction(Request $request, $id)
    {
        ...
        if ("-1" === $id) {
            ...
            $repository = $this->getDoctrine()
                ->getRepository('BinovoTknikaBackupsBundle:Policy');
            $policy = $repository->find($id);
        }
        $form = $this->createForm(new PolicyType(), $policy, array('translator' => $t));
        $form->bind($request);
    ...
    public function getLastLogForLink($link)
    {
        ...
        $dql =<<<EOF
SELECT l
FROM  BinovoTknikaBackupsBundle:LogRecord l
...
EOF;
    ...
    public function showLogsAction(Request $request)
    {
        ...
        $t = $this->get('translator');
        $repository = $this->getDoctrine()
            ->getRepository('BinovoTknikaBackupsBundle:LogRecord');
        ...
        return $this->render('BinovoTknikaBackupsBundle:Default:logs.html.twig',
                             array('pagination' => $pagination,
    ...
    public function showPoliciesAction(Request $request)
    {
        ...
        return $this->render('BinovoTknikaBackupsBundle:Default:policies.html.twig',
                             array('pagination' => $pagination));
    }
    ...
    {
        $response = $this->render('BinovoTknikaBackupsBundle:Default:copyrepository.sh.twig',
    ...
    public function configureRepositoryBackupScriptAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            $result = $this->render('BinovoTknikaBackupsBundle:Default:backupscriptconfig.html.twig',
                                    array('form'            => $form->createView()));
        }
    ...
    {
        $t = $this->get('translator');
        $params = array('database_host'             => array('type' => 'text'    , 'required' => false, 'attr' => array('class' => 'span10'), 'label' => $t->trans('MySQL host'            , array(), 'BinovoTknikaBackups')),
                        'database_port'             => array('type' => 'text'    , 'required' => false, 'attr' => array('class' => 'span10'), 'label' => $t->trans('MySQL port'            , array(), 'BinovoTknikaBackups')),
                        'database_name'             => array('type' => 'text'    , 'required' => false, 'attr' => array('class' => 'span10'), 'label' => $t->trans('MySQL DB name'         , array(), 'BinovoTknikaBackups')),
                        'database_user'             => array('type' => 'text'    , 'required' => false, 'attr' => array('class' => 'span10'), 'label' => $t->trans('MySQL user'            , array(), 'BinovoTknikaBackups')),
                        'database_password'         => array('type' => 'password', 'required' => false, 'attr' => array('class' => 'span10'), 'label' => $t->trans('MySQL password'        , array(), 'BinovoTknikaBackups')),
                        'mailer_transport'          => array('type' => 'choice'  , 'required' => false, 'attr' => array('class' => 'span10'), 'choices' => array('gmail'    => 'gmail',
                                                                                                                                                                 'mail'     => 'mail',
                                                                                                                                                                 'sendmail' => 'sendmail',
                                                                                                                                                                 'smtp'     => 'smtp'),
                                                             'label' => $t->trans('Mailer transpor'       , array(), 'BinovoTknikaBackups')),
                        'mailer_host'               => array('type' => 'text'    , 'required' => false, 'attr' => array('class' => 'span10'), 'label' => $t->trans('Mailer host'           , array(), 'BinovoTknikaBackups')),
                        'mailer_user'               => array('type' => 'text'    , 'required' => false, 'attr' => array('class' => 'span10'), 'label' => $t->trans('Mailer user'           , array(), 'BinovoTknikaBackups')),
                        'mailer_password'           => array('type' => 'text'    , 'required' => false, 'attr' => array('class' => 'span10'), 'label' => $t->trans('Mailer password'       , array(), 'BinovoTknikaBackups')),
                        'upload_dir'                => array('type' => 'text'    , 'required' => false, 'attr' => array('class' => 'span10'), 'label' => $t->trans('Upload dir'            , array(), 'BinovoTknikaBackups')),
                        'backup_dir'                => array('type' => 'text'    , 'required' => false, 'attr' => array('class' => 'span10'), 'label' => $t->trans('Backups dir'           , array(), 'BinovoTknikaBackups')),
                        'max_log_age'               => array('type' => 'choice'  , 'required' => false, 'attr' => array('class' => 'span10'), 'choices' => array('P1D' => $t->trans('One day'    , array(), 'BinovoTknikaBackups'),
                        ...
                        'warning_load_level'        => array('type' => 'percent' , 'required' => false, 'attr' => array('class' => 'span10'), 'label' => $t->trans('Quota warning level'   , array(), 'BinovoTknikaBackups')),
                        'pagination_lines_per_page' => array('type' => 'integer' , 'required' => false, 'attr' => array('class' => 'span10'), 'label' => $t->trans('Records per page'   , array(), 'BinovoTknikaBackups')),
            );
        $defaultData = array();
        ...
        if ($request->isMethod('POST')) {
            ...
            $result = $this->render('BinovoTknikaBackupsBundle:Default:params.html.twig',
                                    array('form'            => $form->createView(),
    ...
    public function deleteUserAction(Request $request, $id)
    {
        if (User::SUPERUSER_ID != $id) {
            $db = $this->getDoctrine();
            $repository = $db->getRepository('BinovoTknikaBackupsBundle:User');
            $manager = $db->getManager();
    ...
    public function editUserAction(Request $request, $id)
    {
        ...
        if ('new' === $id) {
            ...
            $repository = $this->getDoctrine()
                ->getRepository('BinovoTknikaBackupsBundle:User');
            $user = $repository->find($id);
        }
    ...
    public function showUsersAction(Request $request)
    {
        ...
        return $this->render('BinovoTknikaBackupsBundle:Default:users.html.twig',
                             array('pagination' => $pagination));
    }
}
