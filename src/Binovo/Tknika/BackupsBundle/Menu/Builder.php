...
namespace Binovo\Tknika\BackupsBundle\Menu;
    ...
    public function mainMenu(FactoryInterface $factory, array $options)
    {
        ...
        $menu = array(array('label'    => $t->trans('Clients', array(), 'BinovoTknikaBackups'),
                            'children' => array(array('label'    => $t->trans('Show', array(), 'BinovoTknikaBackups'),
                                                ...
                                                array('label'    => $t->trans('Sort jobs', array(), 'BinovoTknikaBackups'),
                                                      'route'    => 'sortJobs'))),
                      array('label'    => $t->trans('Policies', array(), 'BinovoTknikaBackups'),
                            'children' => array(array('label'    => $t->trans('Show', array(), 'BinovoTknikaBackups'),
                                                ...
                                                array('label'    => $t->trans('Add', array(), 'BinovoTknikaBackups'),
                                                      'route'    => 'editPolicy',
                                                      'routeParameters' => array('id' => 'new')))),
                      array('label'    => $t->trans('Scripts', array(), 'BinovoTknikaBackups'),
                            'children' => array(array('label'    => $t->trans('Show', array(), 'BinovoTknikaBackups'),
                                                      'route'    => 'showScripts'),
                                                array('label'    => $t->trans('Add', array(), 'BinovoTknikaBackups'),
                                                      'route'    => 'editScript',
                      ...
                      array('label'    => $t->trans('Config', array(), 'BinovoTknikaBackups'),
                            'children' => array(array('label'    => $t->trans('Manage parameters', array(), 'BinovoTknikaBackups'),
                                                ...
                                                array('label'    => $t->trans('Repository backup script', array(), 'BinovoTknikaBackups'),
