...
abstract class BackupRunningCommand extends LoggingCommand
{
    ...
    {
        $adminEmail       = $this->getContainer()->get('doctrine')->getRepository('BinovoTknikaBackupsBundle:User')->find(User::SUPERUSER_ID)->getEmail();
        ...
        if (count($filteredMessages) && $job->getNotificationsTo()) { // we have something to send and people willing to receive it
            ...
            $message = \Swift_Message::newInstance()
                ...
                ->setFrom($adminEmail)
                ->setTo($recipients)
                ->setBody($engine->render('BinovoTknikaBackupsBundle:Default:logreport.html.twig',
