...
use Binovo\Tknika\TknikaBackupsBundle\Lib\BackupRunningCommand;
...
class RunJobCommand extends BackupRunningCommand
{
    ...
    {
        parent::configure();
        $this->setName('tknikabackups:run_job')
    ...
    protected function executeJob(InputInterface $input, OutputInterface $output)
    {
        ...
        $repository = $container->get('doctrine')->getRepository('BinovoTknikaTknikaBackupsBundle:Job');
