 ...
 */
class Version20130212123446 extends AbstractMigration implements UploadDirAwareInterface
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $scripts = scandir($this->uploadDir);
        ...
        foreach ($scripts as $script) {
            ...
            if (preg_match('/^([0-9]{4})(?:_([0-9]{4}))?[.](pre|post)$/', $script, $matches)) {
                ...
                ++$idScript;
                copy(sprintf('%s/%s', $this->uploadDir, $name), sprintf('%s/%04d.script', $this->uploadDir, $idScript));
                chmod(sprintf('%s/%04d.script', $this->uploadDir, $idScript), 0755);
            }
        }
    }
